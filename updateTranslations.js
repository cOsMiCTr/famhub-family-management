...
// Sample data from the database export
const translations = [
  ...
  { translation_key: 'auth.completeRegistration', en: 'Complete Registration', de: 'Registrierung abschließen', tr: 'Kayıt Tamamla' },
  ...
  { translation_key: 'auth.invitationToken', en: 'Invitation Token', de: 'Einladungstoken', tr: 'Davet Token' },
  ...
  { translation_key: 'common.loading', en: 'Loading...', de: 'Laden...', tr: 'Yükleniyor...' },
  ...
  { translation_key: 'dashboard.recentIncome', en: 'Recent Income', de: 'Kürzliches Einkommen', tr: 'Son Gelirler' },
  ...
  { translation_key: 'households.title', en: 'Households', de: 'Haushalte', tr: 'Haneler' },
  ...
  { translation_key: 'navigation.households', en: 'Households', de: 'Haushalte', tr: 'Haneler' },
  ...
  { translation_key: 'settings.lightMode', en: 'Light Mode', de: 'Heller Modus', tr: 'Aydınlık Mod' },
  ...
  { translation_key: 'translations.addTranslation', en: 'Add Translation', de: 'Übersetzung hinzufügen', tr: 'Çeviri Ekle' },
  { translation_key: 'translations.deleteTranslation', en: 'Delete Translation', de: 'Übersetzung löschen', tr: 'Çeviri Sil' },
  { translation_key: 'translations.editTranslation', en: 'Edit Translation', de: 'Übersetzung bearbeiten', tr: 'Çeviri Düzenle' },
