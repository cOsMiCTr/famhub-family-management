              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    remove all your data, and sign you out.
                  </p>
                  <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded">
                    <p className="text-sm text-red-700 dark:text-red-300">
                      <strong>Warning:</strong> All your assets, income entries, contracts, and personal information will be permanently deleted. 
                      If you have shared ownership in assets, your shares will be redistributed to other members.
                    </p>
                  </div>
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      Type <strong>{currentUsername}</strong> to confirm:
                    </label>
                    <input
                      type="text"
                      value={confirmation}
